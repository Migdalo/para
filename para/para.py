...
def print_results(convertable):
    ...
    log_event(encode_base64, (convertable), 'Encoding base64')
    log_event(decode_base64, (convertable), 'Decoding base64')
    log_event(integer_to_hex, (convertable), 'Integer to hex')
    log_event(hex_to_integer, (convertable), 'Hex to integer')
    log_event(integer_to_ascii, (convertable), 'Integer to ascii')
    log_event(ascii_to_integer, (convertable), 'Ascii to integer')
    log_event(ascii_to_binary, (convertable), 'Ascii to binary')
    log_event(integer_to_binary, (convertable), 'Integer to binary')
    log_event(binary_to_int, (convertable), 'Binary to integer')
